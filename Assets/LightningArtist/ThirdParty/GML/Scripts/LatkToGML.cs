...
public class LatkToGML : MonoBehaviour { 
    ...
    */
    ...
    private IEnumerator postToBook() {
        ...
        */
        List<BrushStroke> strokes = latk.layerList[latk.currentLayer].frameList[latk.layerList[latk.currentLayer].currentFrame].brushStrokeList;
    ...
    string buildGml(List<BrushStroke> strokes, Vector3 _dim) {
        timeCounter = 0f;
